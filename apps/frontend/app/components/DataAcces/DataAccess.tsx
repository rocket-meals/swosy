...
const DataAccess = ({ onOpenBottomSheet }: any) => {
  ...
  const { canteens, buildings, organisations, selectedCanteenFoodOffers, canteenFoodOffers, businessHours, canteenFeedbackLabels, ownCanteenFeedBackLabelEntries } = useAppSelector(state => state.canteenReducer);
