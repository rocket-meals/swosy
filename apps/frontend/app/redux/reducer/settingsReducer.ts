...
const initialState = {
	...
	wikis: [],
        ...
        osmVectorMapShowPOI: true,
        osmVectorMapShowTransit: true,
        osmVectorMapShowRoadNames: true,
        osmVectorMapShowLeisure: true,
        osmVectorMapShowBarriers: true,
	...
	switch (actions.type) {
		...
		case SET_AMOUNT_COLUMNS_FOR_CARDS: {
			return {
                ...
                case SET_OSM_VECTOR_MAP_SHOW_POI: {
                        return {
                                ...state,
                                osmVectorMapShowPOI: actions.payload,
                        };
                }
                case SET_OSM_VECTOR_MAP_SHOW_TRANSIT: {
                        return {
                                ...state,
                                osmVectorMapShowTransit: actions.payload,
                        };
                }
                case SET_OSM_VECTOR_MAP_SHOW_ROAD_NAMES: {
                        return {
                                ...state,
                                osmVectorMapShowRoadNames: actions.payload,
                        };
                }
                case SET_OSM_VECTOR_MAP_SHOW_LEISURE: {
                        return {
                                ...state,
                                osmVectorMapShowLeisure: actions.payload,
                        };
                }
                case SET_OSM_VECTOR_MAP_SHOW_BARRIERS: {
                        return {
                                ...state,
                                osmVectorMapShowBarriers: actions.payload,
                        };
                }
