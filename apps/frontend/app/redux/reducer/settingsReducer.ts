	...
	switch (actions.type) {
		...
		case SET_AMOUNT_COLUMNS_FOR_CARDS: {
			return {
                ...
                case SET_APP_RATING_SCORE: {
                        return {
                                ...state,
                                appRatingScore: actions.payload,
                        };
                }
                case SET_APP_RATING_LAST_FOCUS_TIME: {
                        return {
                                ...state,
                                appRatingLastFocusTime: actions.payload,
                        };
                }
                case CLEAR_SETTINGS: {
                        return {
