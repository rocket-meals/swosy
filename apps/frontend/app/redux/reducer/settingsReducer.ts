import { CHANGE_LANGUAGE, CHANGE_THEME, CLEAR_SETTINGS, SET_AMOUNT_COLUMNS_FOR_CARDS, SET_APARTMENTS_SORTING, SET_APP_SETTINGS, SET_CAMPUSES_SORTING, SET_COLLECTIBLE_ITEM_SIZE, SET_COLLECTIBLE_RANDOM_POSITION, SET_COLOR, SET_DEBUG_MODE, SET_DRAWER_POSITION, SET_FIRST_DAY_OF_THE_WEEK, SET_FOODOFFERS_NEXT_DAY_THRESHOLD, SET_MAP_CLUSTER_PIXEL_RADIUS, SET_MAP_ORGANISATION_FILTER, SET_MAP_SHOW_BUILDING_MARKERS, SET_MAP_SHOW_CLUSTERS, SET_MAP_SHOW_MARKER_LABELS, SET_MAP_TILE_VARIANT_KEY, SET_MAP_USE_FLY_ANIMATION, SET_MAP_VIRTUAL_ZOOM, SET_NICKNAME_LOCAL, SET_OSM_VECTOR_MAP_CLUSTER_DISTANCE, SET_OSM_VECTOR_MAP_ORGANISATION_FILTER, SET_OSM_VECTOR_MAP_PITCH, SET_OSM_VECTOR_MAP_SHOW_BUILDING_MARKERS, SET_OSM_VECTOR_MAP_SHOW_CLUSTERS, SET_OSM_VECTOR_MAP_SHOW_CONTROLS_HINT, SET_OSM_VECTOR_MAP_SHOW_MARKER_LABELS, SET_OSM_VECTOR_MAP_STYLE_KEY, SET_OSM_VECTOR_MAP_USE_FLY_ANIMATION, SET_SELECTED_CUSTOMER, SET_SERVER_INFO, SET_SIMULATE_EXPO_UPDATE_AVAILABLE, SET_SORTING, SET_USE_WEBP_FOR_ASSETS, SET_WARNING, SET_WIKIS, SET_WIKIS_PAGES } from '@/redux/Types/types';
...
const initialState = {
	...
	wikis: [],
        ...
        mapShowBuildingMarkers: true,
        mapShowClusters: true,
        mapShowMarkerLabels: true,
        osmVectorMapShowBuildingMarkers: true,
        osmVectorMapShowClusters: true,
        osmVectorMapShowMarkerLabels: true,
};
	...
	switch (actions.type) {
		...
		case SET_AMOUNT_COLUMNS_FOR_CARDS: {
			return {
                ...
                case SET_MAP_SHOW_BUILDING_MARKERS: {
                        return {
                                ...state,
                                mapShowBuildingMarkers: actions.payload,
                        };
                }
                case SET_MAP_SHOW_CLUSTERS: {
                        return {
                                ...state,
                                mapShowClusters: actions.payload,
                        };
                }
                case SET_MAP_SHOW_MARKER_LABELS: {
                        return {
                                ...state,
                                mapShowMarkerLabels: actions.payload,
                        };
                }
                case SET_OSM_VECTOR_MAP_SHOW_BUILDING_MARKERS: {
                        return {
                                ...state,
                                osmVectorMapShowBuildingMarkers: actions.payload,
                        };
                }
                case SET_OSM_VECTOR_MAP_SHOW_CLUSTERS: {
                        return {
                                ...state,
                                osmVectorMapShowClusters: actions.payload,
                        };
                }
                case SET_OSM_VECTOR_MAP_SHOW_MARKER_LABELS: {
                        return {
                                ...state,
                                osmVectorMapShowMarkerLabels: actions.payload,
                        };
                }
                case CLEAR_SETTINGS: {
                        return {
