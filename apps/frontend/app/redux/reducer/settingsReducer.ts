...
import { ConfigCustomerEnum, getCustomerConfig } from '@/config';
...
const initialState = {
	...
	wikis: [],
        ...
        foodoffersShowSeparatedMarkingsBreakdown: getCustomerConfig().foodoffers_show_separated_markings_breakdown ?? false,
};
