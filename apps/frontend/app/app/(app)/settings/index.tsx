				...
				<View style={sectionStyle}>
					...
					<View style={groupStyle}>
						<SettingsListMyMapThemeSelection
							...
							testID={ComponentIds.SETTINGS_MAP_VARIANTS}
						/>
					</View>
				</View>
			),
