...
const Index = () => {
	...
	return (
		<SafeAreaView style={{ flex: 1, backgroundColor: theme.screen.background }} testID={ComponentIds.EATING_HABITS_MARKINGS} accessibilityLabel={ComponentIds.EATING_HABITS_MARKINGS}>
			<FlatList
				data={markingIds}
