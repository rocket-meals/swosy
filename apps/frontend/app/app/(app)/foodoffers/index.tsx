...
import { SET_BUSINESS_HOURS, SET_SELECTED_CANTEEN_FOOD_OFFERS, SET_SELECTED_CANTEEN_FOOD_OFFERS_LOCAL, SET_SELECTED_DATE, UPDATE_PROFILE } from '@/redux/Types/types';
...
const Index: React.FC<DrawerContentComponentProps> = () => {
	...
	const { sortBy, language: languageCode, drawerPosition, appSettings } = useSelector((state: RootState) => state.settings);
