...
const CampusEmptyState: React.FC<CampusEmptyStateProps> = ({ loading, theme, translate }) => {
    ...
    return (
        <View style={emptyStyles.container}>
            <Text style={{ fontSize: 16, fontFamily: 'Poppins_400Regular', color: theme.screen.text }} testID={ComponentIds.CAMPUS_EMPTY} accessibilityLabel={ComponentIds.CAMPUS_EMPTY}>
