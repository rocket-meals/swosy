...
const LOCATION_WATCH_INTERVAL_MS = 3000;
const LOCATION_WATCH_DISTANCE_M = 5;
...
export default function MapScreen() {
	...
	const startLocationWatch = useCallback(async () => {
		try {
			...
			// Location permission denied or unavailable – user location dot simply won't appear.
		}
	}, []);

	// Start watching location once OSM consent is given
	useEffect(() => {
