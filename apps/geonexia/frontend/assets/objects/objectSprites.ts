...
export interface ObjectSprite {
	 ...
	 * Buildings use ~0.72 (visual footprint center in isometric view).
	 * Ground objects use a value close to the visual bottom (~0.75–0.88).
	 * Default is 1.0 (bottom edge) when omitted.
	 */
	anchorY: number;
}
...
export const OBJECT_SPRITES: ObjectSprite[] = [
	...
	{ name: 'bank', source: require('./bank.svg'), scaleFactor: 8.46, anchorY: 0.72 }, // 4
	...
	{ name: 'buildingConstructionLarge', source: require('./buildingConstructionLarge.svg'), scaleFactor: 10.22, anchorY: 0.72 }, // 9
	{ name: 'buildingConstructionSmall', source: require('./buildingConstructionSmall.svg'), scaleFactor: 6.57, anchorY: 0.72 }, // 10
	...
	{ name: 'castle3', source: require('./castle3.svg'), scaleFactor: 9.32, anchorY: 0.75 }, // 13
	{ name: 'factory', source: require('./factory.svg'), scaleFactor: 8.33, anchorY: 0.72 }, // 14
	...
	{ name: 'farmland', source: require('./farmland.svg'), scaleFactor: 5.8, anchorY: 0.72 }, // 17
	...
	{ name: 'hedge1', source: require('./hedge1.svg'), scaleFactor: 10.22, anchorY: 0.89 }, // 21
	{ name: 'house1', source: require('./house1.svg'), scaleFactor: 4.76, anchorY: 0.70 }, // 22
	{ name: 'houseLarge', source: require('./houseLarge.svg'), scaleFactor: 7.52, anchorY: 0.75 }, // 23
	{ name: 'houseMedium', source: require('./houseMedium.svg'), scaleFactor: 6.43, anchorY: 0.70 }, // 24
	{ name: 'houseModern1', source: require('./houseModern1.svg'), scaleFactor: 8.29, anchorY: 0.72 }, // 25
	...
	{ name: 'shop', source: require('./shop.svg'), scaleFactor: 6.96, anchorY: 0.72 }, // 33
	...
	{ name: 'stone1', source: require('./stone1.svg'), scaleFactor: 3.32, anchorY: 0.74 }, // 36
	...
	{ name: 'stone4', source: require('./stone4.svg'), scaleFactor: 3.69, anchorY: 0.77 }, // 39
	{ name: 'stone5', source: require('./stone5.svg'), scaleFactor: 3.78, anchorY: 0.76 }, // 40
	...
	{ name: 'trainstation', source: require('./trainstation.svg'), scaleFactor: 9.33, anchorY: 0.72 }, // 48
	...
	{ name: 'woodLogs', source: require('./woodLogs.svg'), scaleFactor: 4.09, anchorY: 0.78 }, // 55
	{ name: 'farmFieldFull', source: require('./farmFieldFull.svg'), scaleFactor: 5.57, anchorY: 0.72 }, // 56
];
