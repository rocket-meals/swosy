...
So as we created our map which images of buildings need to be made, we dont want re-enter these
information by hand into the backend once. Therefore this small script creates a JSON file from a
KML file which can be imported into the backend.
