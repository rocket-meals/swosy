...
Steuernummer: 68/213/02808
Umsatzsteuer-Identifikations-Nummer: DE 362633044

E-Mail:

[info@baumgartner-software.de](mailto:info@baumgartner-software)

Website:

 [https://baumgartner-software.de](https://baumgartner-software.de)
...
## Informationen zur Verarbeitung deiner Daten
	...
	### Informationen von Nutzern mit einem Account
		...
		#### Profile
			...
			- devices - Deine verwendeten Endgeräte. Wir verwenden diese Informationen, um z. B. Fehler besser analysieren zu können, abhängig davon, welches Endgerät du verwendest. Weitere Informationen im Abschnitt zu deinem Gerät.
			...
			- course_timetable - Sofern du deinen Stundenplan erstellt hast, wird dieser auch in deinem Profil online gespeichert. Wir analysieren Profile mit Stundenplänen, um überfüllte Essensschlangen zu vermeiden - wir geben diese Daten, außer an das oben gelistete Studierendenwerk, nicht weiter.
...
## Funktionen, Dienste und Dienstleister
	...
	Damit wir dir die App zur Verfügung stellen können, arbeiten wir mit verschiedenen Dienstleistern zusammen, die uns bei der Bereitstellung der App unterstützen. Diese Dienstleister sind sorgfältig ausgewählt und beauftragt, sind an unsere Weisungen gebunden und werden regelmäßig kontrolliert. Sie verarbeiten personenbezogene Daten nur in unserem Auftrag und strikt nach unseren Weisungen. Die Dienstleister werden von uns nur dann beauftragt, wenn sie hinreichend Garantien dafür bieten, dass geeignete technische und organisatorische Maßnahmen so durchgeführt werden, dass die Verarbeitung im Einklang mit den Anforderungen der DSGVO erfolgt und der Schutz deiner Rechte gewährleistet ist.


	### Zusätzliche Weitergabe an das Studierendenwerk Osnabrück

		Die App und die Webseite wurden in Zusammenarbeit mit dem Studierendenwerk entwickelt. Wir als Baumgartner Software UG fungieren zwar als Herausgeber der App, jedoch stammen die Inhalte hauptsächlich vom Studierendenwerk. Um die Services des Studierendenwerks, wie z.B. das Speiseangebot durch Speiserückmeldungen, zu verbessern, teilen wir die hier gelisteten Daten mit dem Studierendenwerk. Das Studierendenwerk hat somit Zugriff auf diese Daten, um deren Angebote und Dienstleistungen besser auf die Bedürfnisse der Studierenden anzupassen.
	...
	### Lageplan
		...
		In unserer App verwenden wir Kartenmaterial auf Basis von OpenStreetMap zur Darstellung von Standorten und Gebäuden. 
		Die Kartendarstellung erfolgt über einen externen Kartendienst (OpenFreeMap / OpenMapTiles), der auf Daten von OpenStreetMap basiert.

		Beim Laden der Karte werden Kartendaten (sogenannte Map Tiles) von Servern des Kartenanbieters geladen. Dabei wird aus technischen Gründen die IP-Adresse des verwendeten Endgeräts sowie technische Informationen zum verwendeten Browser bzw. zur App an diese Server übertragen. Diese Verarbeitung erfolgt ausschließlich zur Bereitstellung der Kartenfunktion.

		Wir erhalten hierbei keine personenbezogenen Daten vom Kartenanbieter und nutzen die Kartenfunktion nicht zu Analyse- oder Trackingzwecken.

		Die Nutzung der Kartenfunktion erfolgt auf Grundlage unseres berechtigten Interesses gemäß Art. 6 Abs. 1 lit. f DSGVO, da die Kartenansicht eine wesentliche Funktion der App zur Darstellung von Standorten darstellt.

		Weitere Informationen zum Datenschutz bei OpenStreetMap findest du unter: https://wiki.osmfoundation.org/wiki/Privacy_Policy



	###  NFC-Zugriff

		Für das Auslesen des Guthabens deiner Mensa-Karte per NFC wird in der App der zuletzt ausgelesene Stand angezeigt und gespeichert. Es findet eine Weiterleitung der Daten an das Backend statt, sodass diese Daten auf deinen Geräten synchronisiert werden. Wir behalten es uns vor, den Verlauf des Guthabens zu analysieren.
	...
	### Planer
		...
		Auf Wunsch können bereits vorhandene Termine und Veranstaltungen von Drittanbietern wie z. B. aus Stud.IP importiert werden. Diese Daten werden ebenfalls lokal abgespeichert und an unseren Server weitergeleitet. Gegebenenfalls werden die IP-Adresse des verwendeten Endgeräts und die entsprechenden REST-Zugriffe für den Datenexport von Drittanbietern wie z. B. Stud.IP selbst geloggt.



	### Vorschlags-System

		Um den Nutzerflow zu optimieren und innerhalb der App bessere und passende Vorschläge zu erhalten, gibt es ein Vorschlagssystem. Die serverseitige Verarbeitung deiner Daten findet statt, wenn du ein Gast-Profil verwendest. Allgemeine Vorschläge, die nutzerunabhängig sind, werden weiterhin gemacht, wie z. B. die Tagesempfehlung oder nur anhand deiner ausgewählten Mensa oder Filter und Sortiereinstellungen.
...
## Kontakt
	...
	[info@baumgartner-software.de](mailto:info@baumgartner-software.de)
