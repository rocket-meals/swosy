...
export const backendTranslations: TranslationResources = {
  ...
  food_feedback_guest_rating_forbidden: {
    de: 'Als Gast kannst du keine Speisen bewerten. Melde dich mit einem Account an, um Bewertungen abzugeben.',
    en: 'As a guest you cannot rate dishes. Please sign in with an account to rate.',
    ar: 'لا يمكنك تقييم الأطباق بصفتك ضيفًا. يرجى تسجيل الدخول بحساب لتتمكن من التقييم.',
    es: 'Como invitado no puedes valorar platos. Inicia sesión con una cuenta para valorar.',
    fr: 'En tant qu’invité, vous ne pouvez pas noter les plats. Veuillez vous connecter avec un compte pour noter.',
    ru: 'Как гость вы не можете оценивать блюда. Войдите с учётной записью, чтобы ставить оценки.',
    tr: 'Misafir olarak yemekleri değerlendiremezsiniz. Değerlendirme yapmak için lütfen bir hesapla giriş yapın.',
    zh: '访客无法为菜品评分。请使用账户登录后再评分。',
  },
  food_feedback_guest_comment_forbidden: {
    de: 'Als Gast kannst du keine Kommentare zu Speisen schreiben. Melde dich mit einem Account an, um zu kommentieren.',
    en: 'As a guest you cannot write comments on dishes. Please sign in with an account to comment.',
    ar: 'لا يمكنك كتابة تعليقات على الأطباق بصفتك ضيفًا. يرجى تسجيل الدخول بحساب لتتمكن من التعليق.',
    es: 'Como invitado no puedes escribir comentarios sobre los platos. Inicia sesión con una cuenta para comentar.',
    fr: 'En tant qu’invité, vous ne pouvez pas commenter les plats. Veuillez vous connecter avec un compte pour commenter.',
    ru: 'Как гость вы не можете оставлять комментарии к блюдам. Войдите с учётной записью, чтобы комментировать.',
    tr: 'Misafir olarak yemeklere yorum yazamazsınız. Yorum yapmak için lütfen bir hesapla giriş yapın.',
