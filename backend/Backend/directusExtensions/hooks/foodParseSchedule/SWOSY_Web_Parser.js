...
import {TL1Parser} from "./TL1Parser.js"

export class SWOSY_Web_Parser {

    amountOfDaysToPull = 8;
    foods = {};
    canteens = {};
    api_url = "";

    constructor(api_url, amountOfDaysToPull) {
        this.foods = {};
        this.canteens = {};
...
//                name: food.name,
    ...
    async getAliasForMealOfferFromRawMealOffer(rawFoodOffer){
    ...
    async getMealNutritionsFromFood(food){
    ...
    getDatesOfAmountNextDaysIncludingToday(amount){
        let dates = [];
    ...
    async getRawMealOffersJSONListForCanteenIdAndDates(canteenId, dates){
        let mealOffers = [];
    ...
    async getRawMealOffersJSONListForCanteenId(canteenId, date){
        date = new Date(date);
