import {ApartmentsParseSchedule} from "./ApartmentsParseSchedule.js"; // in directus we need to add the filetype ... otherwise we get an error
import {StudentenwerkHannoverApartments_Parser} from "./StudentenwerkHannoverApartments_Parser.js"; // in directus we need to add the filetype ... otherwise we get an error
