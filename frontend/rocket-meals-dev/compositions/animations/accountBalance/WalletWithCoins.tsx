...
import walletWithCoins from "../../../assets/accountBalance/walletWithCoins.json";

export const WalletWithCoins = ({children,...props}: any) => {
	...
	return (
		<View style={{width: "100%", alignItems: "center"}}>
			<View style={{width: noFoundWidth}}>
				<Rectangle>
					<CrossLottie source={walletWithCoins} flex={1} />
				</Rectangle>
			</View>
		</View>
	)
