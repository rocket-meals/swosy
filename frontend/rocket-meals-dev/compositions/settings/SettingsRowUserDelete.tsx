...
import {useCurrentUser, useIsCurrentUserAnonymous, useLogoutCallback} from "@/states/User";
    ...
    return(
        <View style={{
            ...
            <View style={{
                ...
                <MyButton useOnlyNecessarySpace={true} accessibilityLabel={translation_confirm} text={translation_confirm} onPress={() => {
                    props.onConfirm(props.hide)
                }} isActive={true} leftIcon={IconNames.confirm_icon} />
            </View>
        </View>
    )
}
