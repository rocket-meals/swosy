...
export const getMyDrawerItemExpoGenerated = (route: any, index: number, props: DrawerContentComponentProps) => {
    ...
    let hide_all_not_especially_defined_drawer_items = !isDebug;
    ...
    return <MyDrawerCustomItem label={label} key={index} isFocused={isFocused} drawerIcon={options.drawerIcon} onPress={onPress} />;
}
