...
export const MyTouchableOpacity = ({disabled, accessibilityRole, accessibilityLabel, onPress, style, children ,...props}: MyTouchableOpacityProps) => {
	...
	if (!onPress) {
		return (
			<View accessibilityState={props?.accessibilityState} accessibilityHint={props?.accessibilityHint} accessibilityLabel={accessibilityLabel} style={mergedStyle}>
				{children}
			</View>
		)
	}
