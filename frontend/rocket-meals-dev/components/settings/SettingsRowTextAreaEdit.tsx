...
import {TestAreaInput, TextInput, View} from '@/components/Themed';
...
interface SettingsRowTextAreaEditSpeicificProps {
...
export type SettingsRowTextAreaEditProps = SettingsRowProps & SettingsRowTextAreaEditSpeicificProps;

export const SettingsRowTextAreaEdit = ({accessibilityLabel, labelLeft, rightIcon,...props}: SettingsRowTextAreaEditProps) => {
