...
function getFinalConfig(_config) {
    const customerConfig = (0, config_1.getCustomerConfig)();
    return {
        "expo": {
            ...
            "ios": {
                ...
                "buildNumber": (0, config_1.getIosBuildNumber)(),
                "infoPlist": {
            ...
            "android": {
                ...
                "versionCode": (0, config_1.getBuildNumber)(),
                "blockedPermissions": [
