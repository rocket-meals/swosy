...
export enum NewsSortType{
	intelligent = "intelligent",
	date = "date"
}
export const sortTypeTranslations = {
	[NewsSortType.intelligent]: "intelligent",
	[NewsSortType.date]: "date",
}
...
export const NewsListHeader: FunctionComponent<AppState> = (props) => {
	...
	function renderHeader(){
		return <HeaderWithActions route={props?.route} title={null} renderActions={renderActions} renderCustomBottom={null} />
