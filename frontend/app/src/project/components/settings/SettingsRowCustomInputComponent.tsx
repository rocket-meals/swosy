...
export const SettingsRowCustomInputComponent: FunctionComponent<AppState> = (props) => {
  ...
  return (
      <SettingsRow accessibilityRole={AccessibilityRoles.adjustable} expanded={editText} onPress={editText ? undefined : () => {if(!editText) {setEditText(!editText)}}} leftContent={description} rightContent={renderContent()} leftIcon={props?.icon} >
          {renderEditActions()}
      </SettingsRow>
  )
}
