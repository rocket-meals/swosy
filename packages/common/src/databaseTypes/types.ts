...
export type AppSettings = {
  ...
  foods_feedbacks_comments_type_for_unverified?: string | null;
...
export type CollectibleEvents = {
  alias?: string | null;
  ask_for_contact_details?: boolean | null;
  collectable_at: string;
  collectible_at_campus?: boolean | null;
  collectible_at_canteen_selection?: boolean | null;
  collectible_at_card_balance?: boolean | null;
  collectible_at_course_timetable?: boolean | null;
  collectible_at_data_access?: boolean | null;
  collectible_at_drawer?: boolean | null;
  collectible_at_faq?: boolean | null;
  collectible_at_foodoffers?: boolean | null;
  collectible_at_foodoffers_details?: boolean | null;
  collectible_at_foodoffers_details_markings?: boolean | null;
  collectible_at_foodoffers_details_nutritions?: boolean | null;
  collectible_at_foodoffers_select_date?: boolean | null;
  collectible_at_foodoffers_sort?: boolean | null;
  collectible_at_housing?: boolean | null;
  collectible_at_license_information?: boolean | null;
  ...
  collectible_at_settings_first_day_of_week?: boolean | null;
  collectible_at_settings_menuposition?: boolean | null;
  collectible_at_settings_theme?: boolean | null;
  collectible_item_image?: string | DirectusFiles | null;
  collectible_item_image_remote_url?: string | null;
  ...
  points_maximum?: number | null;
  points_minimum?: number | null;
  points_settings: string;
  repeat_every_year?: boolean | null;
  sort?: number | null;
  status: string;
